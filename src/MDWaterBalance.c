...
//	printf ("Missing Variables in MDWaterBalance!\n");
	...
	float irrAreaFraction  = MFVarGetFloat(_MDInActIrrAreaID,           itemID, 0.0);
	float waterbalance;
	float infiltration     = MFVarGetFloat(_MDInActIrrAreaID,           itemID, 0.0);
	// float irrPercolation =MFVarGetFloat(_MDInIrrigationDrainageID,itemID, 0.0);
